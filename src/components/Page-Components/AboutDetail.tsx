      ...
      <section className={classes.summary}>
        <div className={classes.paragraph}>
          <p>
            ...
            this private Japanese-Fusion Gastropub operates as a labor of love,
            offering daily healthy and innovative home-cooked meals. With a
            simple wok, a bit of practice, and a commitment to organization, the
            aim is to demonstrate the ease of creating restaurant-quality dishes
            at home affordably.
          </p>
        </div>
        <div className={classes.paragraph}>
        ...
        <div className={classes.paragraph}>
          <p>
            ...
            homebrew experience, and a passion for culinary arts, developed this
            food order app alongside the construction of his in-home restaurant.
            This endeavor doubles as a coding project and a step towards his
            goal of writing &ldquo;The Agile Diner,&ldquo; a testament to his
            journey and expertise in both culinary and coding fields.
          </p>
        </div>
        <div className={classes.paragraph}>
          <p>
            ...
            offers this website, a labor of love and a symbol of his dedication,
            as a birthday gift to his first patron, Calisama.
          </p>
        </div>
